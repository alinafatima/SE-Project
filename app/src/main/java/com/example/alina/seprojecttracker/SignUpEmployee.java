...
import static com.example.alina.seprojecttracker.R.id.designationWrapper;
import static com.example.alina.seprojecttracker.R.id.emailWrapper;
import static com.example.alina.seprojecttracker.R.id.errorname;
import static com.example.alina.seprojecttracker.R.id.fnameWrapper;
import static com.example.alina.seprojecttracker.R.id.passwordWrapper;
...
public class SignUpEmployee extends AppCompatActivity {
    ...
    private EditText etEmail, etName, etPassword, etDesignation, etCode,etPhoneNumber,etconfirmPassword;
    ...
    public void btnSignupOnClick(View view) {
        ...
        final String companyname=etCode.getText().toString();
        final String designation=etDesignation.getText().toString();
        final String phoneNumber=etPhoneNumber.getText().toString();
        final String Status = "Employee";
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                writeNewUser(userEmail, myname, email, password, designation, companyname, phoneNumber, Status);
